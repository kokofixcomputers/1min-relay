...
API Relay for [1minAI](https://1min.ai) – a service that provides an OpenAI-compatible API for using 1minAI models in applications that support the OpenAI API.

## Features

- **Compatibility with OpenAI API** (endpoint `/v1/chat/completions`)
- **Support for Streaming** – allows streaming responses
- **Image Processing Support** – available only for the models: gpt-4o, gpt-4o-mini, and gpt-4-turbo
- **Tools/Function Calling Support** – for applicable models
- **Web Search Support**
- **Token Usage Tracking**

## Limitations

- Image processing is supported only for GPT-4 models.
- The TTS (text-to-speech) feature is temporarily disabled.
- Some models may not support streaming with images.
